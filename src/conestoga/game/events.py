...
class Prerequisite:
    ...
    def is_met(self, game_state) -> bool:
        if self.type == "has_item":
            ...
            return any(
                getattr(m, f"skill_{self.target}", 0) >= (self.value or 0)
                for m in game_state.party
            )
        return True
...
class Choice:
    ...
    def get_lock_reason(self, game_state) -> Optional[str]:
...
class Outcome:
    ...
    success_required: Optional[Dict[str, int]] = None
...
class EventResolution:
    ...
    def apply(self, game_state, rng_seed: Optional[int] = None) -> str:
...
class FallbackDeck:
        ...
        return [
            EventDraft(
                ...
                choices=[
                    ...
                    Choice(id="use_rope", text="Use rope to secure the wagon",
            ...
            EventDraft(
                ...
                choices=[
                    Choice(id="hunt", text="Hunt for food",
            ...
            EventDraft(
                ...
                choices=[
                    Choice(id="buy_food", text="Buy food (20 coins)",
                           prerequisites=[Prerequisite(type="min_resource", target="money", value=20)]),
                    Choice(id="buy_medicine", text="Buy medicine (30 coins)",
    ...
    def get_resolution(self, event_id: str, choice_id: str) -> Optional[EventResolution]:
